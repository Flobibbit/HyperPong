...
export default class Racket {
  ...
  draw(ctx) {
    ...
    ctx.fillRect(
      ...
      this.width,
      -this.height *
        (this.timePassed / this.getCorrectMoveData().cooldownLength)
    );
  }
  ...
  update(timestamp) {
    ...
    if (
      this.yellowMoveData.activated &&
      timestamp - this.yellowMoveData.starttime > this.yellowMoveData.duration
    ) {
      this.ball.ballColor = "#FFFFFF";
      this.yellowMoveData.activated = false;
    }
    if (
      this.blueMoveData.activated &&
      timestamp - this.blueMoveData.starttime > this.blueMoveData.duration
    ) {
      this.blueMoveData.activated = false;
    }
    if (
      this.greenMoveData.activated &&
      timestamp - this.greenMoveData.starttime > this.greenMoveData.duration
    ) {
